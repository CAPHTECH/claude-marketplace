...
description: |
  ...
  コードベースから情報を収集し、実用的なドキュメントに整理する。
  ELD v3: /eld-record（Context Delta収集・知識移転）と連携。
...
知識を体系的に収集・分析・構造化し、将来の開発を強化する高品質なドキュメントを作成する。
...
知識の構造化後、`/eld-record` でContext Deltaを収集し、`tasks/lessons.md`やADRに永続化する。
